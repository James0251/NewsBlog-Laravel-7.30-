            ...
            <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="connection-list">
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                    <a href="#" class="connection-item"><i class="fab fa-github fa-2x"></i><span>Github</span></a>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                                    <a href="#" class="connection-item"><i class="fab fa-bitbucket fa-2x"></i><span>Bitbucket</span></a>
                                </div>
                                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                ...
                <li class="nav-item dropdown nav-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                        ...
                        <a class="dropdown-item" href="#"><i class="fas fa-user mr-2"></i>Личный кабинет</a>
                        <a class="dropdown-item" href="#"><i class="fas fa-cog mr-2"></i>Настройки</a>
                        <a class="dropdown-item" href="{{ route('logout') }}"
                           onclick="event.preventDefault();
                           document.getElementById('logout-form').submit();"><i class="fas fa-power-off mr-2"></i>Выход</a>
